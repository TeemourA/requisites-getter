...
const legal = (props) => {
  return (
    <div className="Form">
      ...
      <div className="Form__group">
        <input className="Form__input" type="text" inputMode="text" name="adress" id="adress" required placeholder=" " onChange={props.handleChange} value={props.requisites.adress} />
      ...
      <div className="Form__group">
        <input className="Form__input" type="text" inputMode="text" name="email" id="email" required placeholder=" " onChange={props.handleChange} value={props.requisites.email} />
        <label className="Form__label" htmlFor="phone">E-mail</label>
      </div>
